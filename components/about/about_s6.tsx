        ...
        <div className="relative w-full h-[70vh] overflow-hidden ">
            ...
            <div className="container">
                <div className=" absolute z-20 flex flex-col w-full h-full justify-start top-24 items-start overflow-hidden">
                    <h1 className="mt-10 other_font font-semibold text-xl md:text-5xl uppercase text-[#2B362D] mb-5">{dict.title}</h1>
                    <p className="w-[90%] md:w-1/3 text-base md:text-lg">{dict.text}</p>
